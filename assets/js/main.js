...
(function ($) {
	...
	$('#mobile-menu ul li a, .sidebar-menu-area ul li a').each(function() {
		var linkPageName = $(this).attr('href').split('/').pop();
			...
			if ($("body")) {
				...
				(window.onmousemove = function (s) {
					...
					$("body").on("mouseenter", "button, a, .cursor-pointer", function () {
						...
						e.classList.add("cursor-big"), t.classList.add("cursor-big");
					...
					$("body").on("mouseleave", "button, a, .cursor-pointer", function () {
						...
						($(this).is("a", "button") &&
							...
							(e.classList.remove("cursor-big"),

								t.classList.remove("cursor-big"));
	...
	$('.form-check-label').click(function(){
		...
		$(this).parent().parent().parent().find('.form-check-input').prop('checked', false);
	...
	$('.form-check-input').click(function(){
		...
		var checkboxContainer = $(this).closest('.behaveradiocheck');
            checkboxContainer.find('.form-check-input').not(this).prop('checked', false);

	})



	var brswiper = new Swiper('.newbrandslider', {
