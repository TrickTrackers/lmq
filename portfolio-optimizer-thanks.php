...
<title>Lumiq - Portfolio Optimizer Thanks</title>
    ...
    <section class="pb-5 ">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-4"> <img src="assets/img/g9.svg" class="img-fluid" alt=""> </div>
          <div class="col-lg-8">
            <p>Thank you for using the Portfolio Optimizer Tool. Your personalized report will arrive in your inbox within 48 hours. Our expert advisor will then guide you through optimizing your investment strategy. </p>
